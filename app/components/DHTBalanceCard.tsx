...
export default function DHTBalanceCard({ balance }: BalanceCardProps) {
  return (
    <div className="w-full flex items-center justify-between rounded-xl py-2 px-4 border-2 border-b-gray-700 border-t-0 border-r-0 border-l-0 bg-gradient-to-b from-gray-700 to-gray-900 rounded-lg">
      {/* Center: DHT Balance */}
